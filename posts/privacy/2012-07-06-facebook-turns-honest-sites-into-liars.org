...
I frequently use [[http://bit.ly/NuEhs2][CNN]] as an example of a typical big-business, high-volume website. Being my /go to/ site for big business, I decided to read their privacy policy. Note that I do not know if CNN uses AdWords or has any relationship with Google. I just used CNN's privacy policy as an example. CNN's privacy policy, conveniently located at [[http://www.cnn.com/privacy.html]], states:
#+BEGIN_QUOTE
